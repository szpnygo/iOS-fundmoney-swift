...
//            }
    ...
    */
    ...
    func touchPoint(touches: NSSet!, withEvent event: UIEvent!){
        ...
        for linePoints:AnyObject in pathPoints {
            let linePointsArray: AnyObject = linePoints
    ...
    */
    ...
    func heightOfString(text: NSString!, width: CGFloat, font: UIFont) -> CGFloat{
        ...
        size = text.boundingRectWithSize(size, options: NSStringDrawingOptions.UsesFontLeading , attributes: tdic as! [String : AnyObject], context: nil).size
        ch = size.height
        return ch
